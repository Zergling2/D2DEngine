...
class Triangle : public D2DEngine::GameObject
{
public:
	Triangle(const D2D1_POINT_2F shape[3]);
	Triangle(D2DEngine::ActiveFlag flag, const wchar_t* name, const D2D1_POINT_2F shape[5], D2DEngine::ObjectTag tag = D2DEngine::ObjectTag::Default);
	virtual ~Triangle() override;

	ip::HullCollider* Collider() { return m_pCollider; }

	bool CreateCollider(const ip::math::Vector2 convexShapeVerticesCCW[3]);
